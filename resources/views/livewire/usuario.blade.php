<div class="container mx-auto px-8">
    ...
    <div class="flex justify-between items-center mb-6">
        <button wire:click="openModal()" class="bg-red-600 text-white font-bold px-6 py-3 rounded-md shadow-lg transition duration-300 hover:bg-red-700 text-lg">NUEVO USUARIO</button>
            ...
            <tbody>
                @forelse($usuarios as $item)
                    <tr class="text-center">
                        ...
                        <td class="px-4 py-2 border">{{ $item->turno }}</td>
                        <td class="px-4 py-2 border">
                            <button wire:click.prevent="editar({{$item->id_usuario}})" class="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600 transition">
                ...
                @empty
                    <tr>
                        <td colspan="6" class="px-4 py-2 text-center text-gray-600">No hay usuarios registrados.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
